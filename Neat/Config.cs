...
namespace Neat
{
    public static class Config
    {
        ...
        public static double offspringFromMutationRatio = 0.6;
        ...
        public static double chanceForNewConnectionMutation = 0.03;
        public static double chanceForNewNeuronMutation = 0.04;
        public static double maxWeightPerturbation = 0.2;
